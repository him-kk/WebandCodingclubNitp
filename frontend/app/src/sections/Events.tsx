            ...
            >
              ...
              <div className="relative bg-void/80 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden group-hover:border-orange/50 transition-colors duration-300">
                ...
                <div className="p-5 md:p-6">
                  ...
                  {/* Register Button */}
                  <button className="w-full mt-4 py-2 bg-orange/10 border border-orange/30 text-orange text-sm font-semibold rounded-lg flex items-center justify-center gap-2 group-hover:bg-orange group-hover:text-black transition-all duration-300">
                    Register Now
